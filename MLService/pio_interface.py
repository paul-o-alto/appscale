...
class PredictionIO():
  """ Class for doing predictionIO operations. """

  # The port SOLR is running on.
  PREDICTIONIO_SERVER_PORT = 8983

  def __init__(self):
    """ Constructor for predictionio interface. """
    self._ml_location = appscale_info.get_ml_location()
